...
if __name__ == "__main__":
    ...
    parser.add_argument("--patience", type=float, help="Whisper decoding patience")
    parser.add_argument("--length_penalty", type=float, help="Whisper length penalty")
    parser.add_argument("--condition_on_previous_text", action="store_true", help="Condition decoding on previous text")
    parser.add_argument("--suffix", type=str, default = "default", help="Suffix used to distinguish transcription outputs")
